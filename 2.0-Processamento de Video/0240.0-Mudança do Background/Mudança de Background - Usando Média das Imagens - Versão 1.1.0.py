...
scene = cv.resize(scene, (640, 480), interpolation = cv.INTER_AREA)
...
while(Video.isOpened()):
  ...
  if Status == True:
    ...
    frame = cv.resize(VideoFrame, (640, 480))
    ...
    if take_bg == True and notify_num>frame_count: # condition to take a background average
        ...
        cv.putText(clone, txt, (10, 50), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)        
