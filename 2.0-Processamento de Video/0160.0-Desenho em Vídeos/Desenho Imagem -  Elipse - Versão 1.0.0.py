...
########################################################################
#
NomeJanela   = "Vídeo com Elipse Desenhada"
...
########################################################################
#
     ImagemAltura = int(imgChuva.shape[0]/2)
     ImagemLargura = int(imgChuva.shape[1]/2)
     ...
     imgChuva = cv.ellipse(imgChuva, PontoCentral, axes, angle, 0, 360, CorLinha, LarguraLinha)
