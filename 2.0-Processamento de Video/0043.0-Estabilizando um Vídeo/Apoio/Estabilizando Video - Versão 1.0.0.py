...
cap = cv2.VideoCapture('/home/asoares/LocalCV/Videos/PianistaNaoEstabilizado.mp4')
...
out = cv2.VideoWriter('/home/asoares/LocalCV/Videos/Avideo_out.mp4', fourcc, fps, (2 * width, height))
